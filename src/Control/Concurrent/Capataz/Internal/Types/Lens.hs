...
notifyEventL
  :: Functor f
    ...
    -> CapatazOptions
    -> f CapatazOptions
notifyEventL k CapatazOptions {notifyEvent, ..}=
...
workerActionL
  ...
  -> WorkerOptions
  -> f WorkerOptions
workerActionL k WorkerOptions {workerAction, ..} =
...
workerNameL
  ...
  -> WorkerOptions
  -> f WorkerOptions
workerNameL k WorkerOptions {workerName, ..} =
...
workerOnFailureL
  ...
  -> WorkerOptions
  -> f WorkerOptions
workerOnFailureL k WorkerOptions {workerOnFailure, ..} =
...
workerOnCompletionL
  ...
  -> WorkerOptions
  -> f WorkerOptions
workerOnCompletionL k WorkerOptions {workerOnCompletion, ..} =
...
workerOnTerminationL
  ...
  -> WorkerOptions
  -> f WorkerOptions
workerOnTerminationL k WorkerOptions {workerOnTermination, ..} =
...
workerTerminationPolicyL
  ...
  -> WorkerOptions
  -> f WorkerOptions
workerTerminationPolicyL k WorkerOptions {workerTerminationPolicy, ..} =
  fmap (\newWorkerAction -> WorkerOptions { workerTerminationPolicy = newWorkerAction, ..})
...
workerRestartStrategyL
  ...
  -> WorkerOptions
  -> f WorkerOptions
workerRestartStrategyL k WorkerOptions {workerRestartStrategy, ..} =
  fmap (\newWorkerAction -> WorkerOptions { workerRestartStrategy = newWorkerAction, ..})
